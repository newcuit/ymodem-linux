...
#ifndef _TTY_YMODEM_H_
#define _TTY_YMODEM_H_
...
#define MASK					((unsigned char)0x7f) 
#define NAK_TIMEOUT             (0x100000)
#define MAX_ERRORS              (5)

/* 函数声明 ------------------------------------------------------------------*/
int32_t Ymodem_Receive (char *);
uint8_t Ymodem_Transmit (uint8_t *,const  char* , uint32_t );
